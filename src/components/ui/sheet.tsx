...
// Drawer de `07` sección 2.4: 452 px a los costados y toda la pantalla por
// debajo de 768 px. En móvil, la X agranda su área táctil a 44 px con un
// `::after` (`07`: objetivos táctiles ≥ 44 px) sin cambiar cómo se ve.
      ...
      >
        ...
        {showCloseButton && (
          <SheetPrimitive.Close data-slot="sheet-close" asChild>
            <Button
              variant="ghost"
              className="absolute top-4 right-4 bg-secondary max-md:after:absolute max-md:after:-inset-[9px]"
              size="icon-sm"
            >
              <XIcon />
