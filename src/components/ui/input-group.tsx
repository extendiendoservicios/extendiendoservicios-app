...
function InputGroupAddon({
  ...
  return (
    // El clic solo adelanta el foco al input vecino (conveniencia de mouse);
    // el input sigue siendo alcanzable por teclado con Tab de forma
    // independiente, así que no hace falta un manejador de teclado acá.
