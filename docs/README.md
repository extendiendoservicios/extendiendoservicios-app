...
| [`features/`](features/usuarios-y-configuracion.md)            | Una página por dominio de administración: quién ve qué, decisiones tomadas, qué falta (primero: `usuarios-y-configuracion.md`, ADM-27 a ADM-31). Un archivo nuevo por paquete desde P07.2/P07.3.                                                                                                                                                                        |
